<template>
    <Page class='document' heading='Cookie Policy'>
        <div class='document__content'>
            <p>
                This is the Cookie Policy for Personal Route, accessible from https://personalroute.com
            </p>
            ...
            <ul>
                <li>
                    <p>
                        Third party authentication services. These services let's you sign up and sign
                        in to our website.
                    </p>
                </li>
            </ul>
            ...
            <p>
                ...
                visiting this link:
                <a href='https://personalroute.com'>https://personalroute.com</a>
            </p>
        </div>
    </Page>
</template>
