<template>
    <Page class='document' heading='Privacy Policy'>
        <div class='document__content'>
            <p>
                At Personal Route, accessible from personalroute.com, one of our main priorities is the
                privacy of our visitors. This Privacy Policy document contains types of information that
                is collected and recorded by Personal Route and how we use it.
            </p>
            ...
            <p>
                ...
                our website with regards to the information that they shared and/or collect in Personal
                Route. This policy is not applicable to any information collected offline or via
            ...
            <p>
                Personal Route follows a standard procedure of using log files. These files log visitors
            ...
            <p>
                Like any other website, Personal Route uses 'cookies'. These cookies are used to store
            ...
            <p>
                Personal Route's Privacy Policy does not apply to other advertisers or websites. Thus,
                we
            ...
            <p>
                Personal Route does not knowingly collect any Personal Identifiable Information from
