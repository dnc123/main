<template>
    <Page class='document' heading='Terms and Conditions'>
        <div class='document__content'>
            <p>Welcome to Personal Route!</p>

            <p>
                These terms of service outline the rules and regulations for the use of
                personalroute.com's Website, located at https://personalroute.com.
            </p>

            <p>
                By accessing this website we assume you accept these terms of service. Do not
                continue to use Personal Route if you do not agree to take all of the terms and
                conditions stated on this page
            </p>

            <p>
                The following terminology applies to these Terms of Service, Privacy Statement
                and
                Disclaimer Notice and all Agreements: "Client", "You" and "Your" refers to you, the
                person log on this website and compliant to the Company’s terms of service. "The
            ...
            <p>
                We employ the use of cookies. By accessing Personal Route, you agreed to use cookies
                in
                agreement with the personalroute.com's Privacy Policy.
            </p>
            ...
            <p>
                Unless otherwise stated, personalroute.com and/or its licensors own the intellectual
                property rights for all material on Personal Route. All intellectual property rights
                are reserved. You may access this from Personal Route for your own personal use
            ...
            <ul>
                <li>Republish material from Personal Route</li>
                <li>Sell, rent or sub-license material from Personal Route</li>
                <li>Reproduce, duplicate or copy material from Personal Route</li>
                <li>Redistribute content from Personal Route</li>
            </ul>
            ...
            <p>
                ...
                and
                information in certain areas of the website. personalroute.com does not filter,
                edit,
                publish or review Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of personalroute.com,its agents and/or affiliates.
                Comments reflect the views and opinions of the person who post their views and
                opinions.
                To the extent permitted by applicable laws, personalroute.com shall not be liable
                for
            ...
            <p>
                personalroute.com reserves the right to monitor all Comments and to remove any
                Comments
            ...
            <p>
                You hereby grant personalroute.com a non-exclusive license to use, reproduce, edit
                and
            ...
            <p>
                ...
                the
                organization does not have any negative records with us; (c) the benefit to us from
                the
                visibility of the hyperlink compensates the absence of personalroute.com; and (d)
                the
            ...
            <p>
                No use of personalroute.com's logo or other artwork will be allowed for linking
                absent a
            ...
            <p>
                ...
                agree
                to protect and defend us against all claims that is rising on your Website. No
                link(s)
                should appear on any Website that may be interpreted as libelous, obscene or
                criminal,
            ...
            <p>
                ...
                our Website. You approve to immediately remove all links to our Website upon request. We
                also reserve the right to amen these terms of service and it’s linking policy at
